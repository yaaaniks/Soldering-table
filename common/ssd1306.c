...
// void ssd1306_timeUpdate() {
//     RTC_Get_Time(&RTC_Data_Brief_Buff);
//     char str[20];
//     ssd1306_Fill(Black);

//     if (RTC_Data_Brief_Buff.hours < 10)
//         sprintf(str, "%d0", RTC_Data_Brief_Buff.hours);
//     else 
//         sprintf(str, "%d", RTC_Data_Brief_Buff.hours);
    
//     ssd1306_SetCursor(98, 8);
//     ssd1306_WriteString(str, Font_6x8, White);

//     sprintf(str, ":%d", RTC_Data_Brief_Buff.minutes);
